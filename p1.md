...
[@1] 工作描述
你的工作是將官方的 MDN 英文手冊翻譯為繁體中文(臺灣)，你將先獲得完整的原文以了解其語境，並接著獲得 Markdowm 格式英文文本，請在兼顧語境、用詞用字(稍後在[@2]及[@3]段落描述)及合理的語法（稍後在[@4]段落描述）的前提下將指定的英文文本翻譯為 Markdowm 格式繁體中文(臺灣)文本。
